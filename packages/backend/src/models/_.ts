...
export type UserGroupsRepository = Repository<MiUserGroup>;
export type UserGroupInvitationsRepository = Repository<MiUserGroupInvitation>;
export type UserGroupJoiningsRepository = Repository<MiUserGroupJoining>;
